      ...
      <div className="container max-w-5xl">
        <div className="grid md:grid-cols-3 gap-8 text-sm">
          ...
          <div>
            ...
            <div className="flex gap-4 text-muted-foreground">
              <a
                href="https://linkedin.com/in/mattchristensen"
                target="_blank"
              ...
              <a
                href="https://instagram.com/mattchristensen"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-accent transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 rounded"
              >
              ...
              <a
                href="https://facebook.com/mattchristensen"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-accent transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 rounded"
              >
        ...
        <div className="mt-10 pt-6 border-t border-border text-center">
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Matt Christensen. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
